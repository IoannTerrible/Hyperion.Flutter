...
class GoogleUsernamePage extends StatefulWidget {
  ...
  @override
  State<GoogleUsernamePage> createState() => _GoogleUsernamePageState();
}

class _GoogleUsernamePageState extends State<GoogleUsernamePage> {
  ...
  Future<void> _create() async {
    ...
    try {
      ...
      final result = await notifier.completeGoogleRegistration(widget.continuationToken, username);
